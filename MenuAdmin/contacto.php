    ...
    <section class="form_wrap">
        ...
        <section class="cantact_info">
            ...
            <section class="info_items">
                <p><span class="fa fa-envelope"></span> info.contact@supertoys.com</p>
                <p><span class="fa fa-mobile"></span> +503 7080-1598</p>
            </section>
        </section>

        <form action="../php/contactanosAdmin.php" method="POST" a class="form_contact">
            <h2>C O N T A C T A N O S</h2>
            <div class="user_info">
                <label for="names">Nombres *</label>
                <input type="text" name="nombres" id="names" required="">
                ...
                <input type="submit" name="enviar" value="Enviar Mensaje" id="btnSend">
            </div>
        </form>
    </section>
