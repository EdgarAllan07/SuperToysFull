...
<html lang="en">
    ...
    <body>
        ...
        <div id="lista-cafe" class="container" align="center"> 
            <h1 id="encabezado" class="encabezado">Mantenimientos</h1>
            <div class="row">
                <div class="row">
                    <div class="four columns">
                        <div class="card">
                            <a href="../php/ListarCliente.php" style="text-decoration: none;">
                    ...
                    <div class="four columns">
                        <div class="card">
                            <a href="MantenimientoEncuestas.php" style="text-decoration: none;">
            ...
            <div class="row">
                <div class="four columns">
                    <div class="card">
                        <a href="../php/listacontactos.php" style="text-decoration: none;">
                ...
                <div class="four columns">
                    <div class="card">
                        <a href="../php/ListarProductos.php" style="text-decoration: none;">
